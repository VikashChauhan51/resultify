...
public readonly struct OneOf<T1, T2, T3, T4, T5, T6> : IEquatable<OneOf<T1, T2, T3, T4, T5, T6>>, IComparable
{
    ...
    public OneOf(T1 value) { _value1 = value; _value2 = default; _value3 = default; _value4 = default; _value5 = default; _value6 = default; _type = OneOfType.T1; }
    public OneOf(T2 value) { _value1 = default; _value2 = value; _value3 = default; _value4 = default; _value5 = default; _value6 = default; _type = OneOfType.T2; }
    public OneOf(T3 value) { _value1 = default; _value2 = default; _value3 = value; _value4 = default; _value5 = default; _value6 = default; _type = OneOfType.T3; }
    public OneOf(T4 value) { _value1 = default; _value2 = default; _value3 = default; _value4 = value; _value5 = default; _value6 = default; _type = OneOfType.T4; }
    public OneOf(T5 value) { _value1 = default; _value2 = default; _value3 = default; _value4 = default; _value5 = value; _value6 = default; _type = OneOfType.T5; }
    public OneOf(T6 value) { _value1 = default; _value2 = default; _value3 = default; _value4 = default; _value5 = default; _value6 = value; _type = OneOfType.T6; }
    ...
    public override bool Equals(object? obj) => obj is OneOf<T1, T2, T3, T4, T5, T6> other && Equals(other);
    ...
    {
        if (obj is not OneOf<T1, T2, T3, T4, T5, T6> other)
    ...
    public static bool operator !=(OneOf<T1, T2, T3, T4, T5, T6> left, OneOf<T1, T2, T3, T4, T5, T6> right) => !left.Equals(right);
    public static bool operator <(OneOf<T1, T2, T3, T4, T5, T6> left, OneOf<T1, T2, T3, T4, T5, T6> right) => left.CompareTo(right) < 0;
    public static bool operator <=(OneOf<T1, T2, T3, T4, T5, T6> left, OneOf<T1, T2, T3, T4, T5, T6> right) => left.CompareTo(right) <= 0;
    public static bool operator >(OneOf<T1, T2, T3, T4, T5, T6> left, OneOf<T1, T2, T3, T4, T5, T6> right) => left.CompareTo(right) > 0;
    public static bool operator >=(OneOf<T1, T2, T3, T4, T5, T6> left, OneOf<T1, T2, T3, T4, T5, T6> right) => left.CompareTo(right) >= 0;
}
